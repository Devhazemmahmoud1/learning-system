												...
												<tr>
													...
													<td>
														<div class="btn-group mb-1">
															<button type="button"
																class="btn btn-outline-success" onclick="window.location.href = '/student/' + {{ $student->serial }}">Info</button>
															<button type="button"
								...
								<form method="POST" action="/add-user" enctype="multipart/form-data"> 
									...
									<div class="modal-body px-4">
										<div class="form-group row mb-6">
											<label for="coverImage" class="col-sm-4 col-lg-2 col-form-label">Student
												Image</label>
										...
										<div class="row mb-2">
											<div class="col-lg-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="firstName" name="fname" placeholder="Please add a full name">
												</div>
											</div>
											...
											<div class="col-lg-6">
												<div class="form-group mb-4">
													<label for="userName">Parent number</label>
											...
											<div class="col-lg-6">
												<div class="form-group mb-4">
													...
													<select class="select" name="group" id="">
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                    </select>
									...
									<div class="modal-footer px-4">
										...
										<button type="submit" class="btn btn-primary btn-pill">Save Student</button>
									</div>
								</form>
							</div>
						</div>
